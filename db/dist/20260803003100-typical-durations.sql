...
--
--   SolarFlow PM · newest module only · 20260803003100_typical_durations.sql
--
...
insert into public.schema_migrations (name) values ('20260803003100_typical_durations.sql')
