...
text "$W/page.html" | grep -q "8 migrations are missing" || fail "the screen does not say eight are missing"
...
assert j['behind'] == ['20260803003400_crm_foundation.sql', '20260803003500_deals.sql',
                       ...
                       '20260803004100_signing_creates_project.sql'], j['behind']
assert '20260803004100_signing_creates_project.sql' in j['bundled'], 'the deployment does not carry its own files'
print('STATE-OK')
PY
...
assert files == ['20260803003400_crm_foundation.sql', '20260803003500_deals.sql',
                 ...
                 '20260803003900_contract_signed_system.sql',
                 '20260803004000_project_holds_contact.sql',
                 '20260803004100_signing_creates_project.sql'], files
...
[ "$(q "select count(*) from public.schema_migrations where name >= '20260803003400'")" = 8 ] \
